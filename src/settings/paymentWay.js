...
class PaymentWay extends React.Component {
  ...
  //添加
  addBotton=()=>{
    this.addEditParams('/addPaymentWay',0,this.stateArray)
  }
  //删除
    ...
    },
     {
      ...
      render: (text, record, index) =><span>
          <Button style={{backgroundColor:'#F4F4f4',marginRight:'10px'}} onClick={()=>{
             this.addEditParams('/addPaymentWay',1,this.stateArray,record) 
             }}>编辑</Button>
      ...
      <div>
        <h2 style={{marginBottom:20}}>
           <Row type="flex" justify="space-between">
              <Col span={12} style={{fontSize:'16px',fontWeight:'700'}}>支付方式</Col>
